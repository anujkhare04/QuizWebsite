	...
	static overrides = {
		...
		plugins: { legend: {
			labels: { generateLabels(chart) {
				...
				const { labels: { pointStyle, textAlign, color: color$1, useBorderRadius, borderRadius } } = chart.legend.options;
