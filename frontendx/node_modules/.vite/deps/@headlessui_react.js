...
import { require_with_selector } from "./with-selector-f8AosKll.js";
...
function $507fabe10e71c6fb$var$triggerChangeHandlers(modality, e$8) {
	for (let handler of $507fabe10e71c6fb$export$901e90a13c50a14e) handler(modality, e$8);
}
/**
...
function $507fabe10e71c6fb$var$handleKeyboardEvent(e$8) {
	...
	if (!$ea8dcbcb9ea1b556$export$95185d699e05d4d7.isOpening && $507fabe10e71c6fb$var$isValidKey(e$8)) {
...
function $507fabe10e71c6fb$var$handlePointerEvent(e$8) {
	...
	$507fabe10e71c6fb$var$currentPointerType = "pointerType" in e$8 ? e$8.pointerType : "mouse";
...
function $507fabe10e71c6fb$var$handleClickEvent(e$8) {
	if (!$ea8dcbcb9ea1b556$export$95185d699e05d4d7.isOpening && $6a7db85432448f7f$export$60278871457622de(e$8)) {
		$507fabe10e71c6fb$var$hasEventBeforeFocus = true;
...
function $9ab94262bd0047c7$export$420e68273165f4ec(props) {
	...
	let onBlur = (0, import_react.useCallback)((e$8) => {
		if (!$d4ee10de306f2510$export$4282f70798064fe0(e$8.currentTarget, e$8.target)) return;
		if (state.current.isFocusWithin && !$d4ee10de306f2510$export$4282f70798064fe0(e$8.currentTarget, e$8.relatedTarget)) {
	...
	let { hoverProps, triggerHoverEnd } = (0, import_react.useMemo)(() => {
		...
		if (typeof PointerEvent !== "undefined") {
			...
			hoverProps$1.onPointerLeave = (e$8) => {
				if (!isDisabled && $d4ee10de306f2510$export$4282f70798064fe0(e$8.currentTarget, e$8.target)) triggerHoverEnd$1(e$8, e$8.pointerType);
			};
		}
		return {
...
var Virtualizer = class {
	constructor(opts) {
		...
		this.scrollToIndex = (index$2, { align: initialAlign = "auto", behavior } = {}) => {
			if (behavior === "smooth" && this.isDynamicMode()) console.warn("The `smooth` scroll behavior is not fully supported with dynamic size.");
			index$2 = Math.max(0, Math.min(index$2, this.options.count - 1));
			this.currentScrollToIndex = index$2;
			let attempts = 0;
			...
			const tryScroll = (currentAlign) => {
				...
				this.targetWindow.requestAnimationFrame(() => {
					const verify = () => {
						if (this.currentScrollToIndex !== index$2) return;
...
function useVirtualizerBase({ useFlushSync = true,...options }) {
	...
	const resolvedOptions = {
		...
		onChange: (instance2, sync) => {
			var _a;
			if (useFlushSync && sync) (0, import_react_dom$6.flushSync)(rerender);
			else rerender();
